...
| `/app/people/[handle]` | Profil eines Mitglieds | member+ (eigenes Profil: free+) | WORKING | `Profile`, `User`, `Follow`, `Connection`, `Post`, `PerformanceRecord`, `TrustReview` | Free/Demo sehen `LockedArea` (Sprint 10/11); Blockierung wirkt |
