    ...
    <div className="flex items-center gap-2">
      <Dropdown
        ...
        trigger={
          <>
            ...
            <span className={compact ? "sr-only sm:not-sr-only sm:inline" : "hidden 2xl:inline"}>{localeLabels[locale]}</span>
            <span className={compact ? "inline sm:hidden" : "inline 2xl:hidden"}>{localeShort[locale]}</span>
          </>
        }
      >
        {(close) =>
      ...
      <Dropdown
        ...
        trigger={
          <>
            {themeIcon}
            <span className="hidden 2xl:inline">{themeText}</span>
          </>
        }
      >
        {(close) =>
