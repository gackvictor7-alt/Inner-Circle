...
export type BadgeVariant = "neutral" | "electric" | "champagne" | "success" | "danger" | "outline";
...
const variants: Record<BadgeVariant, string> = {
  ...
  champagne:
    "bg-champagne-400/15 text-champagne-600 dark:text-champagne-300 border border-champagne-400/30",
