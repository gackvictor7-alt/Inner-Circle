...
import eventsNetworkingImage from "../../../public/images/events-networking.jpg";
import eventsVisionImage from "../../../public/images/events-vision.jpg";
              ...
              <div className="order-2 flex flex-col items-start gap-4 lg:order-1">
                ...
                <ul className="mt-2 space-y-2.5">
                  {page.visionPoints.map((point) => (
                    <li key={point} className="flex items-start gap-2.5 text-sm leading-6 text-foreground-muted">
                      <SparkleIcon size={16} className="mt-1 shrink-0 text-champagne-500 dark:text-champagne-400" />
                      {point}
                    </li>
                  ))}
                </ul>
              </div>
              <div className="relative order-1 overflow-hidden rounded-3xl border border-champagne-400/30 shadow-card lg:order-2">
                <Image
